...
export const sendMessage = async (req, res) => {
    ...
    try {
        ...
        // Publish the message to Redis for real-time update
        redis.publish("messages", JSON.stringify(messageData));

        // Enqueue the message for storing in MongoDB
        await messageQueue.add("storeMessage", messageData);
        
        await redis.del(`messages:${sender}:${receiver}`);
