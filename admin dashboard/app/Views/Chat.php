...
<div class="h-screen flex bg-gray-100">
    ...
    <main class="flex-1 flex flex-col">
        <header class="bg-white border-b border-gray-200 p-4 flex items-center space-x-4">
            ...
            <div class="flex-1">
                <h2 class="font-medium text-gray-800"><?php $row->name; ?></h2>
...
<script>
    ...
    async function sendMessage() {
        ...
        const receiver = "RECEIVER_EMAIL"; // Replace this with the selected receiver's email
    ...
    messages.forEach((msg) => {
        ...
        messageElement.innerHTML = `<div class="max-w-md ${isSender ? "bg-green-200" : "bg-white"} rounded-lg p-3 shadow-sm">
                                        <p class="text-gray-800 text-pretty font-bold">${isSender ? "You" : msg.sender}</p>
